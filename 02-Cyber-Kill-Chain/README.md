...
Compréhension des étapes d'une cyberattaque (modèle Cyber Kill Chain de Lockheed Martin),
pour savoir situer une activité suspecte dans la chaîne d'attaque et prioriser la réponse.

## Prérequis annoncés

- Compréhension de base des concepts de cybersécurité
- Connaissance des OS courants (Windows, Linux)

## Leçons

1. [ ] [Introduction to Cyber Kill Chain](01-Introduction-to-Cyber-Kill-Chain.md)
