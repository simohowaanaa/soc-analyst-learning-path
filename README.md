...
Notes personnelles prises en suivant le [SOC Analyst Learning Path](https://letsdefend.io) sur LetsDefend, section par section.
...
| 24 | [Building a Malware Analysis Lab](24-Building-a-Malware-Analysis-Lab/README.md) | ⬜ |
| 25 | [Building a SOC Lab at Home](25-Building-a-SOC-Lab-at-Home/README.md) | ⬜ |

Légende : ⬜ à faire · 🟨 en cours · ✅ terminé

## Structure

Chaque dossier de section contient :
- `README.md` — vue d'ensemble de la section (résumé, statut)
- un fichier `.md` par leçon/sous-partie, créé au fur et à mesure
