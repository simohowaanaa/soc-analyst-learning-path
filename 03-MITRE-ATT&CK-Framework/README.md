...
Cours théorique sur le framework MITRE ATT&CK : base de connaissance des tactiques et
techniques (TTPs) réellement utilisées par les attaquants. Approfondit un concept déjà
croisé en section 1 (SOAR/playbooks) et section 2 (Cyber Kill Chain).
...
2. [x] [Introduction to MITRE](02-Introduction-to-MITRE.md)
3. [x] [Matrix](03-Matrix.md)
4. [x] [Tactics](04-Tactics.md)
5. [ ] [Techniques and Sub-Techniques](05-Techniques-and-Sub-Techniques.md)
6. [ ] [Mitigations](06-Mitigations.md)
